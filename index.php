...
<li style="color:black; font-weight:bolder;"><?php if(!empty($_SESSION['cart'])){
			...
			<div class="col-md-2">
				...
				<ul>
					...
					<li class="list"><a href="Shoes.php">Shoes</a></li>
					<li class="list"><a href="Shirts.php">Shirts</a></li>
					<li class="list"><a href="Cardigans.php">Hoodies</a></li>
					<li class="list"><a href="Joggers.php">Trousers</a></li>
				</ul>
				</ul>
			</p>
		</div>
			<div class="col-md-3">
				<?php if(isset($_SESSION['user_name'])){?>
					<ul>
				<li style="list-style-type: none; color: rgba(0,0,0,0.6);"><a href="logoutpage.php" style="color:#aaa!important; font-weight:700; text-decoration:none!important; transition: 0.5s;">Logout</a></li>
				<li class="list1"><a href="orderhistory.php">Your Orders</a></li></ul><?php }else{?>
			<ul>
					...
					<li class="list1"><a href="loginpage.php">Login</a></li>
					<li class="list1"><a href="Updateduserpage.php">Sign Up</a></li>
				</ul>
				</ul>
				<?php }?>
			</div>
